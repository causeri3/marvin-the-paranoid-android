from utils.yolo_utils.boundingbox import BoundingBox
...
def postprocess(boxes, scores, classes, img_w, img_h, input_shape, letter_box=True):
    boxes = boxes / np.array([input_shape[0], input_shape[1], input_shape[0], input_shape[1]], dtype=np.float32)
    scores = scores
